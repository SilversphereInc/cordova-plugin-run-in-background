This is a fork of a [plugin](https://bitbucket.org/TheBosZ/cordova-plugin-run-in-background/src/master/) which itself...

...is a fork of [a great plugin by katzer](https://github.com/katzer/cordova-plugin-background-mode/). It aims to keep up-to-date with Android changes while also providing more features.
